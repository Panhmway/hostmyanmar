...
<h1 class="text-center text-white mb-4 fst-normal">In The News</h1>
    <div class="container">
    <div class="row">
        <div class="col">
         <div class=" ms-5 mb-3"><img src="<?php echo $img1;?>" alt="" width="320px" height="350px"></div>
        ...
        <div class="col">
        <div class=" ms-5 mb-3"><img src="images/img2.jpg" alt=""  width="320px" height="350px"></div>
        <div class="text-center text-white text-decoration-underline mt-3"><?php echo $test2 ;?></div>
        <div class="text-center text-white mt-5 fw-light"><?php echo $p ;?></div>
        </p>
        </div>
        <div class="col">
         <div class=" ms-5 mb-3"><img src="images/img3.jpg" alt=""  width="320px" height="350px"></div>
